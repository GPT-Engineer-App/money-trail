...
***Important***
We will validate the prototype by running through all the user stories so make sure you implement **EVERY SINGLE** user story or bad things will happen. Please mock and/or use dummy data if necessary. Also ensure you create 2 initial transactions.
...
```sh
git clone https://github.com/GPT-Engineer-App/money-trail.git
cd money-trail
npm i
```
